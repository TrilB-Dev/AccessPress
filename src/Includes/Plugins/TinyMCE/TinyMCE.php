<?php
/**
 * AccessPress - TinyMCE Plugin
 *
 * @package AccessPress
 * @since 1.0.0
 */

namespace AccessPress\Includes\Plugins\TinyMCE;
...
use AccessPress\Includes\Plugins\TinyMCE\Assets\Assets;
use AccessPress\Includes\Plugins\TinyMCE\Includes\Includes;
use AccessPress\Includes\Plugins\TinyMCE\Includes\Core\I18n;
...
final class TinyMCE implements PluginInterface, SettingsProviderInterface, SettingsPageProviderInterface, AssetsProviderInterface, I18nProviderInterface {
	...
	public function get_description(): string {
		return __( 'Introduces a local TinyMCE 8.8 editor for AccessPress.', 'accesspress' );
	}
	/**
	 * Get the plugin URI.
	 *
