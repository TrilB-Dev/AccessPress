 ...
 * @since 1.0.0
 */
namespace AccessPress\Includes\Plugins\TinyMCE\Includes\Settings;
...
final class Settings {
	...
	public function get_settings_page(): array {
		return array(
			...
			'label'          => __( 'TinyMCE', 'accesspress' ),
			'title'          => __( 'TinyMCE integration', 'accesspress' ),
			'layout'         => 'table',
			'fields'         => array(
				array(
					'key'         => 'tinymce_content_skin',
					'label'       => __( 'Default content skin', 'accesspress' ),
					'description' => __( 'Choose the stylesheet used inside the editor content area.', 'accesspress' ),
					'tooltip'     => __( 'Content skins control typography and content formatting inside the editing area.', 'accesspress' ),
					'type'        => 'select',
				...
				array(
					'key'         => 'tinymce_ui_skin',
					'label'       => __( 'Default user-interface skin', 'accesspress' ),
					'description' => __( 'Choose the TinyMCE toolbar and dialog skin.', 'accesspress' ),
					'tooltip'     => __( 'UI skins control the toolbar, menus, dialogs, and editor chrome.', 'accesspress' ),
					'type'        => 'select',
				...
				array(
					'key'                 => 'tinymce_plugins',
					'label'               => __( 'Enabled TinyMCE plugins', 'accesspress' ),
					'description'         => __( 'Choose which bundled TinyMCE plugins are available to the editor.', 'accesspress' ),
					'tooltip'             => __( 'Only selected local plugin files are requested when an editor starts.', 'accesspress' ),
					'type'                => 'multiselect',
					'dropup_auto'         => false,
					'show_tick'           => true,
