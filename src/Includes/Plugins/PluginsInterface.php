<?php
/**
 * AccessPress Plugin interface for all plugins.
 *
 * @package AccessPress
...
/**
 * Provides an automatically generated settings tab for a AccessPress plugin.
 *
 * @since 1.0.0
 */
...
/**
 * Provides shortcode definitions for a AccessPress extension.
 *
 * @since 1.0.0
 */
...
/**
 * Provides AccessPress admin menu definitions for a plugin.
 *
 * Definitions may use `type => menu` for a new top-level menu or provide a
 * `parent` slug for a submenu under an existing AccessPress menu.
 *
 * @since 1.0.0
 */
...
/**
 * Provides entries for the AccessPress in-page admin sidebar.
 *
 * @since 1.0.0
 */
