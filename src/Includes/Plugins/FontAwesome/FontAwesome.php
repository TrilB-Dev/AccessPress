<?php
/**
 * Font Awesome plugin integration for AccessPress.
 *
 * @package FontAwesome
 * @textdomain accesspress
 * @domainpath Languages
 * @author AccessPress Team
 */

namespace AccessPress\Includes\Plugins\FontAwesome;
...
use AccessPress\Includes\Plugins\FontAwesome\Assets\Assets;
use AccessPress\Includes\Plugins\FontAwesome\Includes\IconPicker;
use AccessPress\Includes\Plugins\FontAwesome\API\FontAwesomeAPI;
use AccessPress\Includes\Plugins\FontAwesome\Includes\Core\I18n;
use AccessPress\Includes\Plugins\FontAwesome\Includes\Includes;
use AccessPress\Includes\Core\WP\Activator;
...
final class FontAwesome implements PluginInterface, SettingsProviderInterface, SettingsPageProviderInterface, AssetsProviderInterface, I18nProviderInterface {
	...
	public function get_slug(): string {
		return 'accesspress-fontawesome';
	}
	/**
	 * Get the plugin name.
	 *
	...
	public function get_description(): string {
		return __( 'Provides Font Awesome enqueueing in Admin, Frontend, Login Page, icon picking, and styling APIs for AccessPress.', 'accesspress' );
	}
	/**
	 * Get the plugin URI.
	 *
	 ...
	 *
	 * WordPress FontAwesome wins first, and AccessPress reuses that namespace and
	...
	private function load_vendor(): void {
		...
		$vendor_file = ACCESSPRESS_DIR . 'vendor/fortawesome/wordpress-fontawesome/index.php';
