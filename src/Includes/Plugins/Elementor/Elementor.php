<?php
/**
 * AccessPress - Elementor AccessPress Plugin
 *
 * @package AccessPress
 * @since 1.0.0
 */
namespace AccessPress\Includes\Plugins\Elementor;
...
final class Elementor implements PluginInterface, SettingsProviderInterface, SettingsPageProviderInterface, AssetsProviderInterface, I18nProviderInterface {
    ...
    private function __construct() {
        ...
        define( 'ACCESSPRESS_ELEMENTOR', ACCESSPRESS_PLUGINS . '/Elementor' );
        define( 'ACCESSPRESS_ELEMENTOR_URL', ACCESSPRESS_PLUGINS_URL . '/Elementor' );
    }
    /**
    ...
    public function get_description(): string {
        return __( 'Provides Elementor integration for AccessPress.', 'accesspress' );
    }
    /**
