<?php
/**
 * Encryption management for AccessPress.
 *
 * @package AccessPress
 */

namespace AccessPress\Includes\UserManagement\Security\Encryption;
...
final class Encryption {
	...
	public static function runtime_key(): ?string {
		...
		if ( defined( 'ACCESSPRESS_ENCRYPTION_KEY' ) ) {
			self::$runtime_key = (string) constant( 'ACCESSPRESS_ENCRYPTION_KEY' );
			return self::$runtime_key;
		}
