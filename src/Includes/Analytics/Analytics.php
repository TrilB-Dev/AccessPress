<?php
/**
 * Core analytics tracker for AccessPress.
 *
 * @package AccessPress\Includes\Analytics
 */
...
final class Analytics {
	...
	/**
	 * Record an analytics event from AccessPress flows.
	 *
	...
	/**
	 * Store a structured log event in the AccessPress logs table.
	 *
