 ...
 *
 * @package AccessPress\Includes\Tools
 */
...
use AccessPress\Includes\Functions\Helpers\TaxonomyHelper;
...
final class DataTransfer {
	...
	public static function validate( $data ): array {
		...
		if ( absint( $data['version'] ?? 0 ) !== self::VERSION ) {
			$errors[] = __( 'This AccessPress export version is not supported.', 'wikipress' );
		}
