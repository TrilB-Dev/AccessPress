...
use AccessPress\Includes\Licence\EncryptionService;
use AccessPress\Includes\Licence\KeyManager;
use AccessPress\Includes\Licence\LicenceGenerator;
use AccessPress\Includes\Licence\LicenceManager;
use AccessPress\Includes\Licence\LicenceTypeManager;
use AccessPress\Includes\Licence\LicenceValidator;
...
final class LicenceCoreTest extends TestCase {
	protected function setUp(): void {
		...
		if ( ! defined( 'ACCESSPRESS_ENCRYPTION_KEY' ) ) {
			define( 'ACCESSPRESS_ENCRYPTION_KEY', Key::createNewRandomKey()->saveToAsciiSafeString() );
		}

		KeyManager::set_runtime_key( (string) constant( 'ACCESSPRESS_ENCRYPTION_KEY' ) );
	}
